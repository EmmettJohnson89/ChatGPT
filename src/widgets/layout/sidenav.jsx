  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-4 m-4">
        <Menu open={openMenu} handler={setOpenMenu} offset={{ mainAxis: '0' }}>
          <MenuHandler>
            <Button
              variant="outlined"
              color={
          ...
          <MenuList className="overflow-visible flex flex-col min-w-[260px] p-0 px-1 bg-gradient-to-br from-blue-gray-800 to-blue-gray-900">
            <MenuItem className="py-2" onClick={() => selectKnowledge('react')}>
              <Typography color="white" className="font-medium text-lg">
                <i className="fas fa-file-lines mr-2" />
                react
              </Typography>
            </MenuItem>
            <MenuItem className="py-2" onClick={() => selectKnowledge('123')}>
              <Typography color="white" className="font-medium text-lg">
                <i className="fas fa-file-lines mr-2" />
                react
              </Typography>
